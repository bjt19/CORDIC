...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone V" DIRECTION="ADD" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_altfp_add_sub_j1k
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_add_altfp_add_sub_j1k
//VALID FILE
...
module fp_add (
	...
	fp_add_altfp_add_sub_j1k	fp_add_altfp_add_sub_j1k_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
