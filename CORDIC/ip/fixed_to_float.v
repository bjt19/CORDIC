...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FIXED2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=18 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=2 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=18 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  fixed_to_float_altbarrel_shift_jof
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[17:0]	sbit_piper1d;
	reg	[17:0]	sbit_piper2d;
	reg	sel_pipec3r1d;
	reg	sel_pipec4r1d;
	wire  [5:0]  dir_w;
	wire  direction_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 18'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[53:36];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 18'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[89:72];
	// synopsys translate_off
	initial
		sel_pipec3r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		direction_w = 1'b0,
		pad_w = {16{1'b0}},
		result = sbit_w[107:90],
		sbit_w = {sbit_piper2d, smux_w[71:54], sbit_piper1d, smux_w[35:0], data},
		sel_w = {sel_pipec4r1d, sel_pipec3r1d, distance[2:0]},
		smux_w = {((({18{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[73:72], pad_w[15:0]}) | ({18{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[89:88]})) | ({18{(~ sel_w[4])}} & sbit_w[89:72])), ((({18{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[63:54], pad_w[7:0]}) | ({18{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[71:62]})) | ({18{(~ sel_w[3])}} & sbit_w[71:54])), ((({18{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[49:36], pad_w[3:0]}) | ({18{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[53:40]})) | ({18{(~ sel_w[2])}} & sbit_w[53:36])), ((({18{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[33:18], pad_w[1:0]}) | ({18{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[35:20]})) | ({18{(~ sel_w[1])}} & sbit_w[35:18])), ((({18{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[16:0], pad_w[0]}) | ({18{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[17:1]})) | ({18{(~ sel_w[0])}} & sbit_w[17:0]))};
endmodule //fixed_to_float_altbarrel_shift_jof
...
module  fixed_to_float_altpriority_encoder_6v7
	...
	fixed_to_float_altpriority_encoder_3v7   altpriority_encoder10
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder10_q));
	fixed_to_float_altpriority_encoder_3e8   altpriority_encoder11
	( 
	.data(data[3:2]),
...
module  fixed_to_float_altpriority_encoder_6e8
	...
	fixed_to_float_altpriority_encoder_3e8   altpriority_encoder12
	( 
	.data(data[1:0]),
...
module  fixed_to_float_altpriority_encoder_bv7
	...
	fixed_to_float_altpriority_encoder_6v7   altpriority_encoder8
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder8_q));
	fixed_to_float_altpriority_encoder_6e8   altpriority_encoder9
	( 
	.data(data[7:4]),
...
module  fixed_to_float_altpriority_encoder_be8
	...
	fixed_to_float_altpriority_encoder_6e8   altpriority_encoder14
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	fixed_to_float_altpriority_encoder_6e8   altpriority_encoder15
	( 
	.data(data[7:4]),
...
module  fixed_to_float_altpriority_encoder_r08
	...
	fixed_to_float_altpriority_encoder_bv7   altpriority_encoder6
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder6_q));
	fixed_to_float_altpriority_encoder_be8   altpriority_encoder7
	( 
	.data(data[15:8]),
...
module  fixed_to_float_altpriority_encoder_rf8
	...
	fixed_to_float_altpriority_encoder_be8   altpriority_encoder16
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	fixed_to_float_altpriority_encoder_be8   altpriority_encoder17
	( 
	.data(data[15:8]),
...
module  fixed_to_float_altpriority_encoder_qb6
	...
	fixed_to_float_altpriority_encoder_r08   altpriority_encoder4
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder4_q));
	fixed_to_float_altpriority_encoder_rf8   altpriority_encoder5
	( 
	.data(data[31:16]),
...
//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 164 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fixed_to_float_altfp_convert_b1o
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	wire  [17:0]   wire_altbarrel_shift3_result;
	...
	reg	[16:0]	mag_int_a_reg;
	reg	[16:0]	mag_int_a_reg2;
	...
	reg	sign_int_a_reg4;
	reg	sign_int_a_reg5;
	wire  [16:0]   wire_add_sub1_result;
	...
	wire  [17:0]  prio_mag_int_a;
	wire  [13:0]  priority_pad_one_w;
	wire  [31:0]  result_w;
	wire  [16:0]  shifted_mag_int_a;
	wire  sign_bus;
	wire  sign_int_a;
	wire  [2:0]  zero_padding_w;

	fixed_to_float_altbarrel_shift_jof   altbarrel_shift3
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg <= 17'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) mag_int_a_reg2 <= 17'b0;
	...
	assign
		...
		mag_int_a = (({17{(~ sign_int_a)}} & int_a) | ({17{sign_int_a}} & int_a_2s)),
		mantissa_bus = mantissa_rounded[22:0],
		mantissa_pre_round = {shifted_mag_int_a[16:0], {7{1'b0}}},
		...
		priority_pad_one_w = {14{1'b1}},
		result = result_reg,
		result_w = {sign_bus, exponent_bus, mantissa_bus},
		shifted_mag_int_a = wire_altbarrel_shift3_result[16:0],
		sign_bus = sign_int_a_reg5,
		sign_int_a = dataa[17],
		zero_padding_w = {3{1'b0}};
endmodule //fixed_to_float_altfp_convert_b1o
//VALID FILE
...
module fixed_to_float (
	...
	fixed_to_float_altfp_convert_b1o	fixed_to_float_altfp_convert_b1o_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
